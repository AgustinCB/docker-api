    ...
    value: function list(opts) {
      ...
      return new Promise(function (resolve, reject) {
        _this.modem.dial(call, function (err, result) {
          ...
          resolve(result.Secrets.map(function (conf) {
            var secret = new Secret(_this.modem, conf.Name);
    ...
    value: function create(opts) {
      ...
      return new Promise(function (resolve, reject) {
        _this2.modem.dial(call, function (err, conf) {
          if (err) return reject(err);
          var secret = new Secret(_this2.modem, conf.Name);
    ...
    value: function status(opts, id) {
      ...
      return new Promise(function (resolve, reject) {
        _this3.modem.dial(call, function (err, conf) {
          if (err) return reject(err);
          var secret = new Secret(_this3.modem, id);
          resolve(Object.assign(secret, conf));
        });
      });
    }
