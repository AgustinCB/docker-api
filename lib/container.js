...
var Container = function () {
  ...
  _createClass(Container, [{
    ...
    value: function prune(opts) {
      ...
      return new Promise(function (resolve, reject) {
        _this17.modem.dial(call, function (err, res) {
          if (err) return reject(err);
          resolve(res);
        });
      });
    ...
    value: function kill(opts, id) {
      ...
      return new Promise(function (resolve, reject) {
        _this21.modem.dial(call, function (err) {
          if (err) return reject(err);
          resolve(_this21.id ? _this21 : new Container(_this21.modem, id));
        });
      });
    }
    ...
    value: function update(opts, id) {
      ...
      return new Promise(function (resolve, reject) {
        _this22.modem.dial(call, function (err, warnings) {
          var container = _this22.id ? _this22 : new Container(_this22.modem, id);
    ...
    value: function unpause(id) {
      ...
      return new Promise(function (resolve, reject) {
        _this25.modem.dial(call, function (err) {
          if (err) return reject(err);
          resolve(_this25.id ? _this25 : new Container(_this25.modem, id));
        });
      });
    }
    ...
    value: function wsattach(opts, id) {
      ...
      return new Promise(function (resolve, reject) {
        _this27.modem.dial(call, function (err, stream) {
          if (err) return reject(err);
          resolve([stream, _this27.id ? _this27 : new Container(_this27.modem, id)]);
        });
      });
    }
    ...
    value: function wait(id) {
      ...
      return new Promise(function (resolve, reject) {
        _this28.modem.dial(call, function (err, code) {
          if (err) return reject(err);
          resolve(code);
        });
      });
    ...
    value: function _delete(opts, id) {
      ...
      return new Promise(function (resolve, reject) {
        _this29.modem.dial(call, function (err) {
          if (err) return reject(err);
          resolve();
        });
      });
    ...
    value: function commit(opts, id) {
      ...
      return new Promise(function (resolve, reject) {
        _this30.modem.dial(call, function (err, res) {
          if (err) return reject(err);
          resolve(new _image2.default(_this30.modem, res.Id.replace("sha256:", "")));
        });
      });
    }
  }, {
