...
var Image = function () {
  ...
  _createClass(Image, [{
    ...
    value: function history(opts, id) {
      ...
      return new Promise(function (resolve, reject) {
        _this6.modem.dial(call, function (err, events) {
          if (err) return reject(err);
          resolve(events);
        });
      });
    ...
    value: function tag(opts, id) {
      ...
      return new Promise(function (resolve, reject) {
        _this8.modem.dial(call, function (err, res) {
          if (err) return reject(err);
          var image = new Image(_this8.modem, id);
          resolve(image);
        });
      }).then(function (image) {
        return image.status();
    ...
    value: function remove(opts, id) {
      ...
      return new Promise(function (resolve, reject) {
        _this9.modem.dial(call, function (err, res) {
          if (err) return reject(err);
          resolve(res);
        });
      });
    ...
    value: function search(opts) {
      ...
      return new Promise(function (resolve, reject) {
        _this10.modem.dial(call, function (err, images) {
          if (err) return reject(err);
          resolve(images);
        });
      });
    ...
    value: function load(file, opts) {
      ...
      return new Promise(function (resolve, reject) {
        _this13.modem.dial(call, function (err, stream) {
          if (err) return reject(err);
          resolve(stream);
        });
      });
